...
public class activity_main_food extends Activity implements ServerListener, OnClickListener
{
	...
	private food_item_proxy server;
	...
	public void onCreate(Bundle savedInstanceState)
	{
        ...
        server = new food_item_proxy(getApplicationContext());
	...
	private AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() {
		public void onItemClick(AdapterView<?> parent, View v, int position,long id) {
			...
			intent.setClass(activity_main_food.this, activity_detail.class);
...
//			activity_main_food.this.finish();
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			{
				loadingView.setVisibility(View.VISIBLE);
				server.sendRequest(activity_main_food.this);
			}
