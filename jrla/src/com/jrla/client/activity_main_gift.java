...
public class activity_main_gift extends Activity implements ServerListener, OnClickListener
{
	...
	private gift_item_proxy server;
	...
	public void onCreate(Bundle savedInstanceState)
	{
        ...
        setContentView(R.layout.layout_main_gift);
        ...
        server = new gift_item_proxy(getApplicationContext());
	...
	private AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() {
		public void onItemClick(AdapterView<?> parent, View v, int position,long id) {
			...
			intent.setClass(activity_main_gift.this, activity_detail.class);
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			{
				loadingView.setVisibility(View.VISIBLE);
				server.sendRequest(activity_main_gift.this);
			}
